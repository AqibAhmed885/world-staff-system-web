  ...
  return (
    <div className="mx-auto flex flex-col lg:flex-row-reverse lg:w-[80%] px-4 md:px-10 lg:px-20 py-5">
      <div className="flex flex-col items-center text-center lg:w-1/2 w-full px-2 lg:px-0">
        <h1 className="text-xl lg:text-2xl font-bold mt-5">Planning <span className="text-custom">To Study</span> Abroad?</h1>
        <p className="text-justify text-sm md:text-base">
          ...
          regarding Technical Intern Training Program (TITP). So that World Staff
          System became the pioneer company to work on Technical Intern Training
          Program (TITP) in Pakistan. The main objective of our company is to
          free skilled people from the scourge of unemployment in Pakistan.
        </p>
      </div>
      <div className="flex w-full lg:w-1/2 items-center justify-center py-5" data-aos="flip-right">
        <img src="src/assets/Japnes/titp-first-section.jpg" alt="" className="max-w-full h-auto" />
      </div>
    </div>
  );
};
