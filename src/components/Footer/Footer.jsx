...
import { MdPhoneIphone, MdPhoneEnabled, MdMailOutline, MdPrint, MdLocationOn, MdCreate } from 'react-icons/md';
...
const FooterSocialLink = ({ href, icon }) => (
    <a className="icon_social text-[#0e87c4]" href={href} target="_blank" rel="noopener noreferrer">
        {icon}
    </a>
);
...
const FooterServices = () => (
    <div className="flex flex-col space-y-4">
        <div className="footer-pad">
            <h3 className='text-[#0e87c4] font-bold'>WSS Services</h3>
            <ul className="flex flex-col space-y-2">
                <li className="flex items-center">
                    <MdCreate className="mr-2 text-[#0e87c4]" size={16} />
                    <Link to="/JapaneseLangCourse" className="hover:underline">Japanese Language Course in Pakistan</Link>
                </li>
                <li className="flex items-center">
                    <MdCreate className="mr-2 text-[#0e87c4]" size={16} />
                    <Link to="/japaneseinjapan" className="hover:underline">Study Visa for Pakistan</Link>
                </li>
                <li className="flex items-center">
                    <MdCreate className="mr-2 text-[#0e87c4]" size={16} />
                    <Link to="/titp" className="hover:underline">TITP Program</Link>
                </li>
            </ul>
        </div>
    </div>
