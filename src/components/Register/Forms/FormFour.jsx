...
const FormFour = ({ nextStep, prevStep }) => {
  ...
  return (
    <>
      <div className='border-2 border-custom p-1 md:p-8 lg:p-12'>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 border-2 border-custom p-4 md:p-8 bg-white max-w-2xl mx-auto">
