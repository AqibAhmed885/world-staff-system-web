...
const Help = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row w-full px-4 md:px-20 py-5">
      <div className="flex flex-col px-4 md:p-20 w-full md:w-1/2" data-aos="flip-right">
        <h1 className="text-2xl md:text-4xl font-bold mb-4">How <span className="text-custom">Can We Help</span> You...?</h1>
        <h3 className="text-lg md:text-xl mb-4 font-bold">We can help you in so many different ways to study in Japan.</h3>
      ...
      <div className="w-full md:w-1/2 flex justify-center items-center" data-aos="flip-left">
        <img src="/study.jpg" alt="" className="max-w-full h-auto px-4 md:p-20"/>
      </div>
    </div>
  );
};
