  ...
  return (
    <nav
      className={`fixed w-full z-50 transition-colors duration-300 ease-in-out ${
        navBg ? "bg-black text-white font-bold" : "bg-white text-black"
      }`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex md:items-center md:space-x-6">
            <Link to="/" className="flex items-center gap-2  font-bold hover:text-gray-300">
            ...
            <div className="relative group">
              <button
                ...
                className="flex items-center gap-2  font-bold hover:text-gray-300 focus:outline-none"
              >
      ...
      >
        <Link
          to="/"
          className="flex items-center gap-2 font-bold block px-3 py-2 rounded-md text-base font-medium"
          onClick={closeMobileMenu}
        >
          <MdOutlineHome className="text-xl" />
          Home
        ...
        <div className="relative group">
          <button
            onClick={toggleAboutDropdown}
            className="flex items-center gap-2 font-bold block px-3 py-2 rounded-md text-base font-medium focus:outline-none flex items-center justify-between" // Added flex, items-center, and justify-between classes
          >
            <FaRegUserCircle className="text-xl" />
            About
        ...
        <div className="relative group">
          <button
            onClick={toggleServicesDropdown}
            className="flex items-center gap-2 font-bold block px-3 py-2 rounded-md text-base font-medium focus:outline-none flex items-center"
          >
            <RiBubbleChartLine className="text-xl" />
            Services
            <HiChevronDown className="ml-1 h-5 w-5" />
        ...
        <Link
          to="/register"
          className="font-bold block px-3 py-2 rounded-md text-base font-medium"
          onClick={closeMobileMenu}
        >
          Register
        </Link>
